export const personalInfo = {
  name: "Jahval Romiz Septrada",
  title: "Data Analyst",
  subtitle: "Turning complex data into clear, actionable business insights.",
  typingPhrases: [
    "transforms raw data into insights.",
    "builds interactive dashboards.",
    "drives data-informed decisions.",
    "tells stories with clear visuals."
  ],
...
export const projects = [
  ...
  {
    id: 4,
    title: "British Airways Customer Feedback Analysis",
...
export const experiences = [
  {
    ...
    description: [
      ...
      "Analyzed and improved reporting structures by enhancing data organization and visualization, increasing clarity and usability for stakeholders.",
      "Leveraged AI-assisted research to quickly understand HR analytics practices and manufacturing business workflows, enabling faster alignment between outputs and business needs."
    ]
  },
  {
    id: 2,
  ...
  {
    id: 3,
    title: "Data Digital Transformation Project",
